...
public class SearchController {
	...
	public ModelAndView search(@RequestParam(value = LOGINID, required = false) String loginId,
			...
			@ModelAttribute(FORM_MODEL) @Validated UserData userdata, BindingResult result, ModelAndView mav) {
		// エラーの数で場合分け
	...
	public ModelAndView resultback(@RequestParam(value = LOGINID2) String loginId,
			@RequestParam(value = USERNAME2) String userName, @RequestParam(value = ICON2) String icon,
